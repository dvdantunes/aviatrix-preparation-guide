...
#### ¿Cuáles son los desafios más comunes en la nube?
...
#### ¿Cuál fue el grupo que inició el movimiento hacia la nube?
...
#### ¿Un problema que los ingenieros de redes enfrentan en la nube que no existe en ambientes OnPremise es?
...
#### ¿Qué servicio se parece más al mundo OnPremise?

R: IaaS

#### ¿Office 365 es un ejemplo de qué servicio?
...
#### ¿Qué servicio de AWS representa una máquina virtual?
...
R: Para implementar un término de conexión híbrida para una VPN o Express Route

#### ¿Qué componente de Azure se utiliza para agrupar items?
...
#### ¿Las subnets en Azure pueden ser creadas tanto públicas como privadas?
...
#### ¿Un ExpressRoute de Azure puede terminar en qué componente?
...
#### ¿Usar ExpressRoute hairpinning para tráfico spoke to spoke es una opción recomendada para el transito en Azure?
...
- SNAT (Source Network Address Translation) es requerido para la simetría de tráfico
...
#### ¿Los recursos de GCP son organizados de acuerdo a qué estructura?
...
#### ¿Qué significa el concepto de Auto Mode en GCP?
...
#### ¿Cuántos DRGs (Dynamic Route Gateway) puedes tener en una región OCI?
...
#### ¿En OCI es simple tener una visibilidad completa y control de toda la red mediante la consola de OCI?

R: Falso

#### ¿El partnership de redes entre Oracle y Azure está disponible en todas las regiones de OCI y Azure?
...
#### ¿Cuáles son algunos beneficios de tener una arquitectura de red multicloud?
...
#### ¿La función de la Capa de Operaciones de MCNA incluye?
...
#### ¿Cuál es el desafío con la encriptación nativa en la nubes?
...
#### ¿Cuánto rendimiento puede alcanzar Aviatrix Firenet?

R: sobre los 70Gbps

#### ¿Cuáles son algunas ventajas de la solución de Aviatrix Site to Cloud (Site2Cloud)?
...
#### ¿Aviatrix Firenet puede orquestar el despliegue y routing de firewall, además del routing para VNET/VPC para implimenetación de NGFW (Next Generation FireWall)?
...
#### ¿Qué funcionalidad de Aviatrix permite a los clientes agrupar VCP/VNETs con políticas de acceso comunes?
...
#### ¿Aviatrix Controller puede realizar auditoría de componentes para asegurarse que ninguna nueva ruta se agregue afectando al funcionamiento correcto de la red?

R: Verdadero

#### ¿Herramientas de resolución de problemas comunes como ping y traceroute pueden ser utilizadas utilizando Aviatrix Gateway?
...
R: Los clientes pueden lanzar un "single controller" e integrar múltiples cuentas cloud para gestionar.

#### ¿CoPilot debe ser desplegado en cada nube para obtener la visibilidad mediante todas las nubes?

R: Falso

#### ¿La topología de CoPilot puede entregar?
...
#### ¿CoPilot no entrega ninguna opción de geo-localización para el tráfico de data?
...
#### ¿En qué Nubes puedes desplegar Aviatrix Controller?
...
#### ¿Cuántos Controllers necesitas normalmente para correr un ambiente multicloud consistente entre OCI, Azure y GCP?

R: 1

#### ¿Para AWS, cual es el método recomendado o más fácil para desplegar Aviatrix Controller?

R: Con la plantilla de CloudFormation desde doc.aviatrix.com
